  ...
  html: `
    <div class="s-content">
      ...
      <table class="s-table s-table-3col">
        ...
        <tbody>
          <tr><td class="purple-text"><strong>РОЛЬ</strong></td><td>Кем должен быть ИИ</td><td class="code-text">«Ты — опытный спичрайтер Правительства Новосибирской области»</td></tr>
...
Контекст: 25 апреля 2026, торжественное открытие нового 4-этажного корпуса Новосибирского областного онкологического диспансера. Аудитория: медицинские работники, пациенты, федеральные гости. Ключевое сообщение: Новосибирская область вкладывает в здоровье людей — это не слова, это 840 млн рублей и 3 года строительства.
...
2. Что значит этот корпус для жителей Новосибирской области (2 абзаца)
    ...
    <div class="s-content">
      ...
      <div class="s-practice-cards">
        <div class="practice-card">
          ...
          <div class="practice-desc">2 мая, технопарк «Новосибирск Иннотех», первый региональный центр стартапов. Речь губернатора на 7 минут. Факты: 3 200 м², 12 резидентов, якорный партнёр — Сбер.</div>
        </div>
        <div class="practice-card">
...
Контекст: 2 мая 2026, открытие технопарка «Новосибирск Иннотех» — первый региональный центр поддержки технологических стартапов. Площадь: 3 200 м². 12 резидентов подписали соглашения. Якорный партнёр — Сбер. Аудитория: предприниматели, инвесторы, студенты НГУ и НГТУ, гости из Минэконома.
...
Ограничение: ...` },
    { label: 'Шаблон Задание В (ответ на обращение)', text: `Роль: Ты — специалист аппарата Правительства Новосибирской области по работе с обращениями граждан.
    ...
    <div class="s-content">
      ...
      <div class="s-iterations">
        ...
        <div class="iteration good-iteration">
          ...
          <div class="iter-content">
            <code>Роль: Правовой аналитик Минэкономразвития Новосибирской области.
...
Ограничение: только то, что есть в текстах. [СТАРАЯ РЕДАКЦИЯ] --- [НОВАЯ РЕДАКЦИЯ]</code>
  ...
  prompts: [
    { label: 'Итерация 3 — анализ документа (рабочий)', text: `Роль: Ты — правовой аналитик Министерства экономического развития Новосибирской области.

Контекст: Два варианта постановления о субсидиях малому бизнесу Новосибирской области. Нужно понять, что изменилось, и оценить влияние на предпринимателей.
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-practice-cards s-practice-cards-4">
        ...
        <div class="practice-card"><div class="practice-letter">Г</div><div class="practice-title">Позиция на переговорах</div><div class="practice-desc">Совещание с Минфином РФ. Новосибирская область хочет +2 млрд руб. на дороги в Маслянинском и Сузунском районах. Минфин против.</div></div>
      </div>
    </div>`,
  speakerNotes: 'Напомнить про артефакты — они доступны на сайте по кнопке "Артефакты" внизу экрана.',
  prompts: [
    { label: 'Шаблон А — Саммари из источников', text: `Роль: Ты — аналитик в аппарате Правительства Новосибирской области.
...
Ограничение: только факты из документов, одна страница.` },
    { label: 'Шаблон Б — Сравнение редакций постановления', text: `Роль: Ты — правовой аналитик Правительства Новосибирской области.
...
Контекст: законопроект Министерства образования Новосибирской области о дополнительных льготах педагогам сельских школ. Нужно оценить риски несоответствия федеральному законодательству.
...
Контекст: Новосибирская область ведёт переговоры с Министерством финансов РФ о дополнительных инфраструктурных кредитах на дорожное строительство.
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-prompt-block good-prompt" style="margin-top:16px">
        ...
        <code>Доклад: «Демографическая ситуация в Новосибирской области и меры поддержки рождаемости. I квартал 2026».
...
8 слайдов, деловой стиль, акцент на цифры и конкретику.</code>
  ...
  prompts: [
    { label: 'Промпт для Gamma — демография Новосибирской области', text: `Доклад: «Демографическая ситуация в Новосибирской области и меры поддержки рождаемости. I квартал 2026».
Аудитория: представители Министерства экономического развития РФ.
Цель: обосновать план мероприятий и запросить методическую поддержку.
Структура:
  Слайд 1: Текущая ситуация (факт 1,38 vs план 1,6, место в рейтинге)
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-prompt-block good-prompt" style="margin-top:16px">
        ...
        <code>Создай HTML-страницу на русском языке для предпринимателей Новосибирской области: «Как получить субсидию малому бизнесу: что изменилось с апреля 2026»
...
4. Список документов
5. Контакты: Министерство экономического развития Новосибирской области
...
Стиль: чистый, деловой, адаптивный. Цвета: синий и белый.</code>
  ...
  prompts: [
    { label: 'Промпт для Replit — страница о субсидиях', text: `Создай HTML-страницу на русском языке для предпринимателей Новосибирской области: «Как получить субсидию малому бизнесу: что изменилось с апреля 2026»
...
3. Пошаговая инструкция (4 шага с иконками)
4. Список документов
5. Контакты: Министерство экономического развития Новосибирской области, телефон, email
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-practice-cards s-practice-cards-5">
        <div class="practice-card"><div class="practice-letter">А</div><div class="practice-title">Сравнение региональных стратегий</div><div class="practice-desc">Перед стратегической сессией Новосибирской области. Сравнить Татарстан, Тюменскую и Нижегородскую области — как привлекают инвестиции.</div><div class="practice-tools"><a href="https://perplexity.ai" target="_blank">Perplexity</a><a href="https://chat.qwen.ai" target="_blank">Qwen</a></div></div>
        <div class="practice-card"><div class="practice-letter">Б</div><div class="practice-title">Сценарное моделирование</div><div class="practice-desc">Новосибирская область рассматривает 6 млрд руб. гарантий для «Академгородок 2.0». Три сценария: оптимистичный, базовый, пессимистичный.</div><div class="practice-tools"><a href="https://chat.qwen.ai" target="_blank">Qwen</a><a href="https://chat.deepseek.com" target="_blank">DeepSeek</a></div></div>
        <div class="practice-card"><div class="practice-letter">В</div><div class="practice-title">Оценка технологических трендов</div><div class="practice-desc">Минцифры Новосибирской области готовит доклад «ИИ для регионального управления» для Комиссии при Президенте. Топ-5 технологий.</div><div class="practice-tools"><a href="https://perplexity.ai" target="_blank">Perplexity</a><a href="https://www.kimi.com" target="_blank">Kimi</a></div></div>
        ...
        <div class="practice-card"><div class="practice-letter">Е</div><div class="practice-title">Навигатор господдержки</div><div class="practice-desc">Сервис для жителей Новосибирской области: подобрать все меры поддержки, открыть условия и пройти шаги до подачи заявки через Госуслуги, МФЦ или ведомство.</div><div class="practice-tools"><a href="https://replit.com" target="_blank">Replit</a><a href="https://chat.qwen.ai" target="_blank">Qwen</a></div></div>
      </div>
    </div>`,
...
Контекст: подготовка к стратегической сессии по развитию Новосибирской области.
Задача: сравни подходы трёх регионов к привлечению инвестиций.
Формат — таблица:
  | Параметр | Татарстан | Тюменская обл. | Нижегородская обл. | Новосибирская область |
  Параметры: стратегические приоритеты / инструменты привлечения / ключевые результаты / что отличает от других
После: топ-3 практики, применимые в Новосибирской области — с кратким обоснованием.
...
Контекст: Новосибирская область рассматривает предоставление государственных гарантий на 6 млрд руб. для реализации проекта «Академгородок 2.0». Нужно оценить риски и возможности.

Задача: разработай три финансовых сценария.

Формат — три блока:
ОПТИМИСТИЧНЫЙ: условия → ключевые показатели → выгоды для Новосибирской области → остаточные риски
...
Контекст: Минцифры Новосибирской области готовит доклад «ИИ для регионального управления» для Комиссии при Президенте РФ по развитию ИИ.
...
После таблицы: рекомендация — с какой технологии Новосибирской области начать и почему (1 абзац).

Ограничение: только реально работающие решения, не концепты. С примерами из других регионов.` },
    { label: 'Шаблон Г — Презентация в Gamma', text: `Создай структуру презентации на 8 слайдов для совещания по развитию Новосибирской области.

Тема: [вставьте тему — например, поддержка рождаемости / развитие ИИ / инвестиции / туризм].

Аудитория: губернатор, вице-губернаторы, министры.
...
3. Текущая ситуация в Новосибирской области
...
Стиль: деловой, кратко, без воды, с акцентом на цифры. Формат: текст для вставки в Gamma.` },
    { label: 'Шаблон Е — Навигатор господдержки для жителей Новосибирской области', text: `Создай HTML-прототип сервиса «Навигатор господдержки для жителей Новосибирской области».
...
Пользователь: житель Новосибирской области. Возможные статусы: молодая семья, многодетная семья, пенсионер, человек с инвалидностью, участник СВО или член семьи, безработный, студент, предприниматель, человек в трудной жизненной ситуации.
...
- данные можно сделать демонстрационными, но реалистичными для Новосибирской области.` }
  ],
  hasTask: true,
...
Контекст: ты работаешь в аппарате Правительства Новосибирской области. Все совещания оформляются в едином формате.
...
<li><strong>Региональный вклад Новосибирской области:</strong> ~80 млрд руб. прямых инвестиций</li>
</ul>`
      },
      {
...
<li><strong>Запрашиваемая госгарантия Новосибирской области:</strong> 100% = <strong>6 млрд руб.</strong></li>
...
<li><strong>Альтернатива (если Новосибирская область отказывает):</strong> Газпромбанк требует доп. залог 4,2 млрд руб. → задержка проекта 18–24 мес.</li>
</ul>`
      }
    ]
  },
    ...
    sections: [
      {
        ...
        content: `<ul>
<li><strong>Аудитория:</strong> губернатор, вице-губернаторы, министры, руководители профильных ведомств.</li>
...
<li>Инвестиционная привлекательность Новосибирской области.</li>
...
<li>Текущая ситуация в Новосибирской области.</li>
...
<li>Что нужно решить сегодня.</li>
  ...
  P3E: {
    ...
    title: 'Артефакт Е — ТЗ на сервис «Навигатор господдержки для жителей Новосибирской области»',
    sections: [
      {
        title: 'ИДЕЯ СЕРВИСА',
...
<li><strong>Данные:</strong> можно использовать демонстрационные меры, но они должны выглядеть реалистично для Новосибирской области.</li>
</ul>`
      },
      {
