    ...
    <div class="s-content">
      ...
      <div class="s-tools-grid">
        <div class="tool-category">
          ...
          <a href="https://gigachat.ru" target="_blank" class="tool-link">GigaChat <span class="tool-note">gigachat.ru · данные в РФ</span></a>
          <a href="https://chat.deepseek.com" target="_blank" class="tool-link">DeepSeek <span class="tool-note">chat.deepseek.com</span></a>
          <a href="https://kimi.moonshot.cn" target="_blank" class="tool-link">Kimi <span class="tool-note">kimi.moonshot.cn</span></a>
        ...
        <div class="tool-category">
          ...
          <a href="https://ya.ru/neurosearch" target="_blank" class="tool-link">Яндекс Нейро <span class="tool-note">ya.ru/neurosearch</span></a>
        </div>
        <div class="tool-category">
...
Ограничение: уважительный тон, конкретика, не отписка, до 250 слов.` }
  ...
  taskHtml: `
    <div class="task-panel-inner">
      ...
      <div class="task-hint">Используйте кнопку «Скопировать шаблон» ниже для быстрого старта</div>
    </div>`
},
...
Контекст ситуации: [добавьте свои детали]` }
  ...
  hasTask: true,
  taskHtml: `<div class="task-panel-inner"><div class="task-header">⏱ ПРАКТИКА 2 · 17 минут</div><p>Выберите задание А, Б, В или Г. Артефакты — кнопка внизу экрана.</p></div>`
},
  ...
  html: `
    <div class="s-break">
      ...
      <div class="s-tools-quick">
        ...
        <a href="https://gigachat.ru" target="_blank" class="tool-quick-btn">GigaChat</a>
  ...
  html: `
    <div class="s-content">
      ...
      <div class="demo-tools-row">
        ...
        <a href="https://ya.ru/neurosearch" target="_blank" class="demo-tool-btn">Яндекс Нейро ↗</a>
        <a href="https://kimi.moonshot.cn" target="_blank" class="demo-tool-btn">Kimi ↗</a>
      </div>
...
Ограничение: конкретные факты, не общие слова.` }
  ...
  hasTask: true,
  taskHtml: `<div class="task-panel-inner"><div class="task-header">⏱ ПРАКТИКА 3 · 17 минут</div><p>Выберите задание. Для сбора данных — Perplexity. Для анализа — Qwen.</p></div>`
},
...
Ограничение: только то, что есть в расшифровке. Если данных нет — оставить поле пустым, не домысливать.` }
  ...
  hasTask: true,
  taskHtml: `<div class="task-panel-inner"><div class="task-header">⏱ ПРАКТИКА 6 · 7 минут</div><p>Выберите одну повторяющуюся задачу. Напишите шаблон-промпт. Сохраните в Telegram → Избранное или в Qwen.</p><div class="task-hint">Идеи: еженедельный отчёт по подразделению / ответ на обращение граждан / согласование документа</div></div>`
},

// ─────────── БЛОК 7 ───────────
{
  id: 31, type: 'block-header', block: 7, blockName: 'Блок 7',
  html: `
    <div class="s-block-header">
...
// ─────────── ШПАРГАЛКА ───────────
{
  id: 32, type: 'content', block: 7, blockName: 'Блок 7',
  html: `
    <div class="s-content">
...
// ─────────── ПРОГРАММЫ ШКОЛЫ 21 ───────────
{
  id: 33, type: 'table', block: 7, blockName: 'Блок 7',
  html: `
    <div class="s-content">
...
// ─────────── РЕТРОСПЕКТИВА ───────────
{
  id: 34, type: 'content', block: 7, blockName: 'Блок 7',
  html: `
    <div class="s-content">
...
// ─────────── ФИНАЛ ───────────
{
  id: 35, type: 'final', block: 7, blockName: 'Финал',
  html: `
    <div class="s-final">
...
window.BLOCKS = [
  ...
  { id: 8, name: 'Блок 7 · Финал', duration: 25, startSlide: 31 },
];
