...
// ─────────── ПРАКТИКА 3 ───────────
{
  ...
  html: `
    <div class="s-content">
      ...
      <h2 class="s-heading">ВЫБЕРИТЕ ЗАДАНИЕ</h2>
      <div class="s-practice-cards s-practice-cards-6">
        ...
        <div class="practice-card"><div class="practice-letter">Д</div><div class="practice-title">Провести исследование</div><div class="practice-desc">Найти 5–7 источников по выбранной теме, выделить факты, риски и выводы для руководителя. Использовать Perplexity или Kimi.</div></div>
        <div class="practice-card"><div class="practice-letter">Е</div><div class="practice-title">Создать приложение</div><div class="practice-desc">Сделать простой прототип страницы или калькулятора для граждан/бизнеса: форма, результат, понятный интерфейс. Использовать Replit.</div></div>
      </div>
    </div>`,
  speakerNotes: 'Шесть вариантов: аналитика, сценарии, тренды, презентация, исследование, приложение. Пусть выбирают самый близкий к своей работе.',
  prompts: [
...
Стиль: деловой, кратко, без воды, с акцентом на цифры. Формат: текст для вставки в Gamma.` },
    { label: 'Шаблон Д — Исследование с источниками', text: `Роль: Ты — исследователь-аналитик для регионального правительства.

Тема исследования: [вставьте тему].

Задача: найди и обобщи актуальные факты, практики и риски по теме.

Формат:
1. Краткий вывод для руководителя — 5 строк
2. 5–7 ключевых фактов с источниками
3. Какие регионы/страны уже сделали похожее
4. Что применимо для НСО
5. Риски и ограничения
6. Что проверить дополнительно перед докладом

Ограничение: не придумывай факты. Если данных мало — прямо напиши, чего не хватает.` },
    { label: 'Шаблон Е — Прототип приложения в Replit', text: `Создай простой веб-прототип на русском языке.

Тема: [например, калькулятор субсидии / навигатор мер поддержки / запись на консультацию / чек-лист документов].

Пользователь: житель НСО, предприниматель или сотрудник ведомства.

Функции:
1. Короткое описание сервиса
2. Форма с 3–5 полями
3. Кнопка расчёта или подбора рекомендации
4. Блок результата с понятным объяснением
5. Список следующих шагов
...
- все тексты на русском языке.` }
  ...
  hasTask: true,
  artifacts: ['P3A', 'P3B'],
  taskHtml: `<div class="task-panel-inner"><div class="task-header">⏱ ПРАКТИКА 3 · 17 минут</div><p>Выберите один из 6 кейсов: аналитика, сценарии, тренды, презентация, исследование или приложение.</p><div class="task-hint">Нажмите «Скопировать промпт» ниже — это <strong>пример для старта</strong>, адаптируйте под свою задачу</div></div>`
},
