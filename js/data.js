...
// ─────────── ТИТУЛ ───────────
{
  ...
  html: `
    <div class="s-title">
      ...
      <h1 class="s-main-title gradient-text">ИИ ×<br><span class="audience-title">Команда аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе</span></h1>
...
// ─────────── НОВОСИБИРСКАЯ ОБЛАСТЬ ───────────
{
  ...
  html: `
    <div class="s-content">
      <h2 class="s-heading">НОВОСИБИРСКАЯ ОБЛАСТЬ: МЫ УЖЕ В ПОВЕСТКЕ</h2>
      <div class="s-cards-grid">
        ...
        <div class="s-card green-border">
          ...
          <div class="s-card-text">Минцифры Новосибирской области запустило ИИ-помощника для чиновников (Habr, 2025)</div>
        </div>
        <div class="s-card purple-border">
          <div class="s-card-icon">🎓</div>
  ...
  speakerNotes: 'Показать что Новосибирская область не отстаёт. Последняя карточка — политическая реальность: ИИ в повестке у Президента.',
  prompts: [], hasTask: false,
},
  ...
  html: `
    <div class="s-content">
      ...
      <table class="s-table s-table-3col">
        ...
        <tbody>
          <tr><td class="purple-text"><strong>РОЛЬ</strong></td><td>Кем должен быть ИИ</td><td class="code-text">«Ты — аналитик аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе»</td></tr>
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-prompt-block good-prompt">
        ...
        <code>Роль: Ты — спичрайтер аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе. Пишешь для первых лиц. Никаких канцеляризмов.

Контекст: 25 апреля 2026, торжественное открытие нового 4-этажного корпуса Новосибирского областного онкологического диспансера. Планируется участие полномочного представителя Президента Российской Федерации в Сибирском федеральном округе. Аудитория: медицинские работники, пациенты, руководство региона, федеральные гости. Ключевое сообщение: новый корпус важен для жителей региона и показывает, как федеральная и региональная повестка сходятся в конкретном результате — 840 млн рублей и 3 года строительства.
...
2. Что значит этот корпус для жителей региона и системы здравоохранения Сибирского федерального округа (2 абзаца)
...
Ограничение: без штампов («в непростое время», «хочу поблагодарить всех»). Факты не придумывать: корпус — 4 этажа, 840 млн руб., открывается 25 апреля. Всё остальное — общие слова.</code>
  ...
  prompts: [
    { label: 'Хороший промпт — речь онкоцентр', text: `Роль: Ты — спичрайтер аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе. Пишешь для первых лиц. Никаких канцеляризмов.
...
// ─────────── ПРАКТИКА 1 ───────────
{
    ...
    <div class="s-content">
      ...
      <div class="s-practice-cards">
        <div class="practice-card">
          ...
          <div class="practice-desc">2 мая, технопарк «Новосибирск Иннотех», первый региональный центр стартапов. Тезисы для выступления полномочного представителя на 7 минут. Факты: 3 200 м², 12 резидентов, якорный партнёр — Сбер.</div>
        </div>
        <div class="practice-card">
  ...
  prompts: [
    { label: 'Шаблон Задание А (речь)', text: `Роль: Ты — спичрайтер аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе.

Контекст: 2 мая 2026, открытие технопарка «Новосибирск Иннотех» — первый региональный центр поддержки технологических стартапов. Площадь: 3 200 м². 12 резидентов подписали соглашения. Якорный партнёр — Сбер. Планируется участие полномочного представителя. Аудитория: предприниматели, инвесторы, студенты НГУ и НГТУ, представители региона и федеральных ведомств.

Задача: напиши тезисы выступления полномочного представителя на 7 минут.
...
Контекст: В Новосибирской области с 1 июня 2026 года отменяется льготный проезд для пенсионеров на пригородных поездах. Вместо него — ежемесячная денежная компенсация 400 руб. через Госуслуги.
...
Ограничение: ...` },
    { label: 'Шаблон Задание В (ответ на обращение)', text: `Роль: Ты — аналитик аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе по работе с обращениями граждан.
...
Задача: подготовь проект ответа и короткую позицию для координации с региональным правительством.
    ...
    <div class="s-content">
      ...
      <div class="s-iterations">
        ...
        <div class="iteration good-iteration">
          ...
          <div class="iter-content">
            <code>Роль: Правовой аналитик аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе.
Задача: сравни две редакции регионального постановления о субсидиях.
Формат — таблица:
...
Ограничение: только то, что есть в текстах. [СТАРАЯ РЕДАКЦИЯ] --- [НОВАЯ РЕДАКЦИЯ]</code>
  ...
  prompts: [
    { label: 'Итерация 3 — анализ документа (рабочий)', text: `Роль: Ты — правовой аналитик аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе.

Контекст: Два варианта регионального постановления о субсидиях малому бизнесу в Новосибирской области. Нужно понять, что изменилось, и оценить влияние на предпринимателей для справки на межведомственное совещание.
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-practice-cards s-practice-cards-4">
        <div class="practice-card"><div class="practice-letter">А</div><div class="practice-title">Саммари из трёх источников</div><div class="practice-desc">Пятница 17:45. К понедельнику нужна краткая справка полномочному представителю по нацпроектам за квартал. Используйте Артефакт А.</div></div>
        <div class="practice-card"><div class="practice-letter">Б</div><div class="practice-title">Сравнение двух редакций</div><div class="practice-desc">Новая редакция постановления о субсидиях. Справка для координационного совещания с регионом. Используйте Артефакт Б.</div></div>
        ...
        <div class="practice-card"><div class="practice-letter">Г</div><div class="practice-title">Позиция на переговорах</div><div class="practice-desc">Совещание с Минфином РФ и регионом. Субъект Сибирского федерального округа запрашивает +2 млрд руб. на дороги. Минфин против.</div></div>
      </div>
    </div>`,
  speakerNotes: 'Напомнить про артефакты — они доступны на сайте по кнопке "Артефакты" внизу экрана.',
  prompts: [
    { label: 'Шаблон А — Саммари из источников', text: `Роль: Ты — аналитик аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе.
Контекст: три документа — [перечислите].
Задача: сделай единое саммари для полномочного представителя.
Формат:
...
Ограничение: только факты из документов, одна страница.` },
    { label: 'Шаблон Б — Сравнение редакций постановления', text: `Роль: Ты — правовой аналитик аппарата полномочного представителя Президента Российской Федерации в Сибирском федеральном округе.

Контекст: нужно подготовить аналитическую справку для координационного совещания с регионом — что изменилось в постановлении о субсидиях малому бизнесу (Артефакт Б).
...
После таблицы: вывод для полномочного представителя — 2–3 предложения.
...
Контекст: законопроект субъекта Сибирского федерального округа о дополнительных льготах педагогам сельских школ. Нужно оценить риски несоответствия федеральному законодательству.
...
Контекст: субъект Сибирского федерального округа ведёт переговоры с Министерством финансов РФ о дополнительных инфраструктурных кредитах на дорожное строительство. Аппарату полномочного представителя нужна нейтральная позиция для координации сторон.
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-prompt-block good-prompt" style="margin-top:16px">
        ...
        <code>Доклад: «Демографическая ситуация в одном из субъектов Сибирского федерального округа и меры поддержки рождаемости. I квартал 2026».
Аудитория: полномочный представитель, представители Министерства экономического развития РФ и региональной команды.
Цель: показать ситуацию, варианты действий и вопросы для межведомственной координации.
Структура:
  ...
  Слайд 5: Вопросы для координации с федеральными ведомствами
8 слайдов, деловой стиль, акцент на цифры и конкретику.</code>
  ...
  prompts: [
    { label: 'Промпт для Gamma — демография субъекта СФО', text: `Доклад: «Демографическая ситуация в одном из субъектов Сибирского федерального округа и меры поддержки рождаемости. I квартал 2026».
Аудитория: полномочный представитель, представители Министерства экономического развития РФ и региональной команды.
Цель: показать ситуацию, варианты действий и вопросы для межведомственной координации.
Структура:
  Слайд 1: Текущая ситуация (факт 1,38 vs план 1,6, место в рейтинге)
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-prompt-block good-prompt" style="margin-top:16px">
        ...
        <code>Создай HTML-страницу на русском языке для предпринимателей субъекта Сибирского федерального округа: «Как получить субсидию малому бизнесу: что изменилось с апреля 2026»
...
4. Список документов
5. Контакты: региональное министерство экономического развития, МФЦ и профильный портал
...
Стиль: чистый, деловой, адаптивный. Цвета: синий и белый.</code>
  ...
  prompts: [
    { label: 'Промпт для Replit — страница о субсидиях', text: `Создай HTML-страницу на русском языке для предпринимателей субъекта Сибирского федерального округа: «Как получить субсидию малому бизнесу: что изменилось с апреля 2026»
...
3. Пошаговая инструкция (4 шага с иконками)
4. Список документов
5. Контакты: региональное министерство экономического развития, МФЦ, профильный портал, телефон, email
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-practice-cards s-practice-cards-5">
        <div class="practice-card"><div class="practice-letter">А</div><div class="practice-title">Сравнение региональных стратегий</div><div class="practice-desc">Перед стратегической сессией аппарата полпреда. Сравнить Татарстан, Тюменскую и Нижегородскую области с одним из субъектов Сибирского федерального округа — как привлекают инвестиции.</div><div class="practice-tools"><a href="https://perplexity.ai" target="_blank">Perplexity</a><a href="https://chat.qwen.ai" target="_blank">Qwen</a></div></div>
        <div class="practice-card"><div class="practice-letter">Б</div><div class="practice-title">Сценарное моделирование</div><div class="practice-desc">Субъект Сибирского федерального округа рассматривает 6 млрд руб. гарантий для «Академгородок 2.0». Три сценария: оптимистичный, базовый, пессимистичный.</div><div class="practice-tools"><a href="https://chat.qwen.ai" target="_blank">Qwen</a><a href="https://chat.deepseek.com" target="_blank">DeepSeek</a></div></div>
        <div class="practice-card"><div class="practice-letter">В</div><div class="practice-title">Оценка технологических трендов</div><div class="practice-desc">Нужен обзор для аппарата полпреда: какие технологии ИИ реалистично внедрять в региональном управлении субъектов СФО. Топ-5 технологий.</div><div class="practice-tools"><a href="https://perplexity.ai" target="_blank">Perplexity</a><a href="https://www.kimi.com" target="_blank">Kimi</a></div></div>
        ...
        <div class="practice-card"><div class="practice-letter">Е</div><div class="practice-title">Навигатор господдержки</div><div class="practice-desc">Прототип сервиса для жителя субъекта Сибирского федерального округа: подобрать меры поддержки, открыть условия и пройти шаги до подачи заявки через Госуслуги, МФЦ или ведомство.</div><div class="practice-tools"><a href="https://replit.com" target="_blank">Replit</a><a href="https://chat.qwen.ai" target="_blank">Qwen</a></div></div>
      </div>
    </div>`,
...
Контекст: подготовка к стратегической сессии аппарата полномочного представителя по развитию субъектов Сибирского федерального округа.
Задача: сравни подходы трёх регионов к привлечению инвестиций.
Формат — таблица:
  | Параметр | Татарстан | Тюменская обл. | Нижегородская обл. | Субъект СФО |
  Параметры: стратегические приоритеты / инструменты привлечения / ключевые результаты / что отличает от других
После: топ-3 практики, применимые в субъектах Сибирского федерального округа — с кратким обоснованием.
...
Контекст: субъект Сибирского федерального округа рассматривает предоставление государственных гарантий на 6 млрд руб. для реализации проекта «Академгородок 2.0». Нужно оценить риски и возможности для справки аппарату полномочного представителя.

Задача: разработай три финансовых сценария.

Формат — три блока:
ОПТИМИСТИЧНЫЙ: условия → ключевые показатели → выгоды для региона и округа → остаточные риски
...
Контекст: аппарат полномочного представителя готовит обзор «ИИ для регионального управления» по субъектам Сибирского федерального округа для Комиссии при Президенте РФ по развитию ИИ.
...
После таблицы: рекомендация — с какой технологии субъектам Сибирского федерального округа начать и почему (1 абзац).

Ограничение: только реально работающие решения, не концепты. С примерами из других регионов.` },
    { label: 'Шаблон Г — Презентация в Gamma', text: `Создай структуру презентации на 8 слайдов для совещания по развитию выбранного субъекта Сибирского федерального округа.

Тема: [вставьте тему — например, поддержка рождаемости / развитие ИИ / инвестиции / туризм].

Аудитория: полномочный представитель, заместители полномочного представителя, представители региональной команды и профильных федеральных ведомств.

Цель: быстро показать ситуацию, варианты решений и следующий шаг.

Структура:
1. Заголовок и главный вывод
2. Почему тема важна сейчас
3. Текущая ситуация в выбранном субъекте Сибирского федерального округа
4. 3 ключевые проблемы
5. Лучшие практики других регионов
6. 3 варианта решения
7. Рекомендуемый вариант
8. Что нужно решить сегодня

Стиль: деловой, кратко, без воды, с акцентом на цифры. Формат: текст для вставки в Gamma.` },
    { label: 'Шаблон Е — Навигатор господдержки для жителей субъекта СФО', text: `Создай HTML-прототип сервиса «Навигатор господдержки для жителей субъекта Сибирского федерального округа».

Цель сервиса: помочь жителю найти все подходящие меры государственной поддержки, разобраться в условиях и пошагово дойти до подачи заявки.

Пользователь: житель субъекта Сибирского федерального округа. Возможные статусы: молодая семья, многодетная семья, пенсионер, человек с инвалидностью, участник СВО или член семьи, безработный, студент, предприниматель, человек в трудной жизненной ситуации.

Что должен уметь прототип:
1. Задать пользователю базовые вопросы: возраст, состав семьи, дети, занятость, доход, льготный статус, район/город проживания.
2. Показать список подходящих мер поддержки.
3. По каждой мере открыть подробную карточку: кому положено, размер поддержки, условия, документы, сроки, ограничения.
4. Дать пошаговый маршрут подачи заявки.
5. Указать способ подачи: Госуслуги, МФЦ, региональный портал, профильное ведомство или иной канал.
6. Подсказать, какие документы подготовить заранее.
7. Завершить конкретным следующим шагом: «перейти на Госуслуги», «записаться в МФЦ», «подготовить справку», «проверить право».

Требования:
- один HTML-файл
- адаптивно для телефона
- чистый деловой стиль
- без внешних библиотек
- все тексты на русском языке
- данные можно сделать демонстрационными, но реалистичными для одного из субъектов Сибирского федерального округа.` }
  ],
  hasTask: true,
  ...
  html: `
    <div class="s-content">
      ...
      <div class="s-prompt-block good-prompt">
        ...
        <code>Роль: Ты — помощник по протоколированию межведомственных совещаний.
Контекст: ты работаешь в аппарате полномочного представителя Президента Российской Федерации в Сибирском федеральном округе. Совещания с регионами и федеральными ведомствами оформляются в едином формате.
...
Ограничение: только то, что есть в расшифровке. Если данных нет — поле пустым, не домысливать.</code>
  ...
  prompts: [
    { label: 'Системный промпт — Протокол совещания', text: `Роль: Ты — помощник по протоколированию межведомственных совещаний.
Контекст: ты работаешь в аппарате полномочного представителя Президента Российской Федерации в Сибирском федеральном округе. Совещания с регионами и федеральными ведомствами оформляются в едином формате.
Задача: превращай расшифровки совещаний в структурированный протокол.
Формат — всегда одинаковый:
...
// ─────────── ФИНАЛ ───────────
{
  ...
  html: `
    <div class="s-final">
      ...
      <div class="final-survey">
        <div class="final-qr-card">
          <img src="assets/qr-code.svg" alt="QR-код опроса" class="final-qr">
          <a href="http://opros.so/pBf1G" target="_blank" class="final-survey-link">opros.so/pBf1G</a>
          <div class="resource-desc">Опрос по итогам воркшопа</div>
        </div>
        <div class="final-contact-card">
          <div class="resource-title">Дамир Байжуминов</div>
          <div class="final-contact-line">Тел./MAX: <a href="tel:+79663688868">+7(966) 36-888-68</a></div>
          <div class="final-contact-line">tg: <a href="https://t.me/Damir_bai" target="_blank">@Damir_bai</a></div>
        </div>
      </div>
...
<li>Минобр — интернет в школах: из 847 школ Новосибирской области широкополосный интернет проведён в 712 (84%).</li>
</ol>
...
<li>Минобру — план по 135 отстающим школам (приоритет: отдалённые районы) до 30.04.2026</li>
      ...
      },
      {
        ...
        subtitle: 'Исх. № 3412/МЭ от 10 апреля 2026. Губернатору Новосибирской области',
        content: `<p>О предоставлении отчётности по нацпроекту «Демография», показатель «Рождаемость».</p>
<p>По данным Росстата за I квартал 2026 г. Новосибирская область занимает <strong>47 место</strong> среди субъектов РФ по суммарному коэффициенту рождаемости (1,38 при целевом — 1,6). Отставание от плана: <strong>13,8%</strong>.</p>
...
<li>Предложения по дополнительным мероприятиям с оценкой бюджетной потребности</li>
      ...
      {
        title: 'КЛЮЧЕВЫЕ ПОКАЗАТЕЛИ НОВОСИБИРСКОЙ ОБЛАСТИ — I квартал 2026',
        subtitle: 'Тезисы',
        content: `<ul>
    ...
    sections: [
      {
        ...
        subtitle: 'Постановление Правительства Новосибирской области «О субсидиях субъектам малого предпринимательства»',
        content: `<ul>
...
<li>Ст. 15 <span style="color:#44EB99">(новая)</span>: Доля расходов на маркетинг — не более 20% от субсидии</li>
  ...
  P2C: {
    ...
    sections: [
      {
        title: 'ЗАКОНОПРОЕКТ НОВОСИБИРСКОЙ ОБЛАСТИ (проект)',
        subtitle: 'О внесении изменений в Закон Новосибирской области № 258-ОЗ «О мерах социальной поддержки педагогических работников»',
        content: `<p><strong>Статья 1.</strong> Внести в Закон Новосибирской области № 258-ОЗ следующие изменения:</p>
...
<p><strong>1.4</strong> Контроль возложить на Министерство образования Новосибирской области.</p>`
      },
      {
...
<li><strong>Приказ Минпросвещения РФ № 196</strong>: номенклатура должностей педагогических работников — перечень закрытый. Расширительное толкование без изменения федерального акта неправомерно.</li>
  ...
  P2D: {
    ...
    sections: [
      {
        title: 'ЗАПРОС НОВОСИБИРСКОЙ ОБЛАСТИ',
...
<li><strong>Сузунский район:</strong> подъезд к промзоне «Сузун-Агро» (22 км) — 1 800 рабочих мест, крупнейший агрокластер Новосибирской области. Смета: <strong>0,8 млрд руб.</strong></li>
<li><strong>Экономический эффект:</strong> снижение логистических издержек −18%, рост налоговых поступлений +340 млн руб./год (оценка МЭР Новосибирской области).</li>
</ul>`
      },
      {
        ...
        content: `<ul>
<li>Новосибирская область получила инфраструктурный кредит в 2023 году (1,5 млрд руб.) — плановый лимит на 2026 г. исчерпан.</li>
<li>Долговая нагрузка Новосибирской области — <strong>48%</strong> собственных доходов; Минфин РФ применяет порог 50% для новых кредитов.</li>
...
<li>Альтернатива Минфина: нацпроект «Безопасные качественные дороги» — срок подачи заявок истёк в феврале 2026.</li>
      ...
      },
      {
        ...
        subtitle: 'Факты для усиления позиции Новосибирской области',
        content: `<ul>
...
<li><strong>Политический фактор:</strong> депутат ГД от Новосибирской области направил запрос в Правительство РФ.</li>
...
<li><strong>Отличие:</strong> соглашения с Ростех, Росатом как якорные инвесторы — частный бизнес идёт следом.</li>
      ...
      {
        title: 'НОВОСИБИРСКАЯ ОБЛАСТЬ — ТЕКУЩАЯ СИТУАЦИЯ',
...
<li><strong>Региональный вклад:</strong> ~80 млрд руб. прямых инвестиций</li>
</ul>`
      },
      {
...
<li><strong>Запрашиваемая госгарантия региона:</strong> 100% = <strong>6 млрд руб.</strong></li>
...
<li><strong>Альтернатива (если регион отказывает):</strong> Газпромбанк требует доп. залог 4,2 млрд руб. → задержка проекта 18–24 мес.</li>
</ul>`
      }
    ]
  },
  ...
  P3C: {
    tabLabel: 'В — ИИ в госуправлении',
    title: 'Артефакт В — Карта ИИ-решений для регионального управления',
    sections: [
      {
        title: 'НАПРАВЛЕНИЯ ПРИМЕНЕНИЯ',
        subtitle: 'Где ИИ может дать эффект в региональном управлении',
        content: `<ul>
<li><strong>Обращения граждан:</strong> классификация тем, подготовка черновиков ответов, выявление повторяющихся проблем по районам.</li>
<li><strong>Документооборот:</strong> резюме длинных документов, проверка противоречий, сравнение версий, список замечаний.</li>
<li><strong>Контроль поручений:</strong> извлечение задач из протоколов, напоминания, риск просрочки, еженедельные сводки.</li>
<li><strong>Аналитика:</strong> мониторинг региональных практик, сравнение показателей, подготовка справок для руководителя.</li>
<li><strong>Городская среда:</strong> анализ жалоб, фотофиксация проблем, приоритизация ремонта и благоустройства.</li>
</ul>`
      },
      {
        title: 'КРИТЕРИИ ОТБОРА ТОП-5',
        subtitle: 'Как выбирать технологии для внедрения',
        content: `<ul>
<li><strong>Готовность:</strong> есть работающие решения, которые можно протестировать в течение 1–3 месяцев.</li>
<li><strong>Безопасность:</strong> можно работать без передачи закрытых или персональных данных в публичные сервисы.</li>
<li><strong>Понятный эффект:</strong> экономия времени, снижение ошибок, ускорение ответа гражданину или руководителю.</li>
<li><strong>Масштабируемость:</strong> решение применимо не в одном отделе, а в нескольких ведомствах.</li>
<li><strong>Контроль человеком:</strong> ИИ готовит черновик или рекомендацию, финальное решение остаётся за сотрудником.</li>
</ul>`
      },
      {
        title: 'ФОРМАТ РЕЗУЛЬТАТА',
        subtitle: 'Что должно получиться у группы',
        content: `<p>Таблица на 5 строк:</p>
<table class="s-table">
<thead><tr><th>Технология</th><th>Задача региона</th><th>Первый пилот</th><th>Риск</th></tr></thead>
<tbody>
<tr><td>ИИ для обращений</td><td>Сократить время ответа</td><td>1 ведомство, 1 категория обращений</td><td>Качество и тон ответа</td></tr>
<tr><td>ИИ-резюме документов</td><td>Быстро читать большие пакеты</td><td>Аппарат правительства</td><td>Пропуск важной детали</td></tr>
</tbody>
</table>`
      }
    ]
  ...
  P3D: {
    tabLabel: 'Г — Бриф презентации',
    title: 'Артефакт Г — Бриф для презентации на совещание',
    sections: [
      {
        title: 'ИСХОДНАЯ СИТУАЦИЯ',
        subtitle: 'Что известно перед подготовкой презентации',
        content: `<ul>
<li><strong>Аудитория:</strong> полномочный представитель, заместители полномочного представителя, представители региона и профильных федеральных ведомств.</li>
<li><strong>Время на доклад:</strong> 7 минут, затем 5 минут на вопросы.</li>
<li><strong>Ожидаемый итог:</strong> выбрать один управленческий шаг: поручение, пилот, межведомственная группа или запрос в федеральный центр.</li>
<li><strong>Тон:</strong> коротко, делово, без длинной методологии. В каждом слайде должен быть вывод.</li>
</ul>`
      },
      {
        title: 'ТЕМЫ НА ВЫБОР',
        subtitle: 'Можно взять одну из тем или заменить на свою',
        content: `<ul>
<li>Демография и поддержка семей с детьми.</li>
<li>Инвестиционная привлекательность выбранного субъекта Сибирского федерального округа.</li>
<li>ИИ в региональном управлении.</li>
<li>Туризм и событийная экономика.</li>
<li>Поддержка малого бизнеса и самозанятых.</li>
</ul>`
      },
      {
        title: 'ОБЯЗАТЕЛЬНАЯ СТРУКТУРА',
        subtitle: '8 слайдов для Gamma',
        content: `<ol>
<li>Главный вывод и решение, которое нужно принять.</li>
<li>Почему тема важна сейчас.</li>
<li>Текущая ситуация в выбранном субъекте Сибирского федерального округа.</li>
<li>3 ключевые проблемы.</li>
<li>Лучшие практики других регионов.</li>
<li>3 варианта решения.</li>
<li>Рекомендуемый вариант.</li>
<li>Что нужно решить сегодня.</li>
</ol>`
      }
    ]
  },
  ...
  P3E: {
    tabLabel: 'Е — Навигатор господдержки',
    title: 'Артефакт Е — ТЗ на сервис «Навигатор господдержки для жителей субъекта СФО»',
    sections: [
      {
        title: 'ИДЕЯ СЕРВИСА',
        subtitle: 'Что должен получить житель',
        content: `<p>Житель отвечает на несколько вопросов о себе и получает список подходящих мер поддержки. По каждой мере он видит условия, документы, сроки и понятный маршрут подачи заявки.</p>
<ul>
<li><strong>Главная ценность:</strong> не искать поддержку по разным сайтам ведомств, а получить персональный список в одном месте.</li>
<li><strong>Формат прототипа:</strong> одна HTML-страница с анкетой, результатом и карточками мер поддержки.</li>
<li><strong>Данные:</strong> можно использовать демонстрационные меры, но они должны выглядеть реалистично для одного из субъектов Сибирского федерального округа.</li>
</ul>`
      },
      {
        title: 'АНКЕТА ПОЛЬЗОВАТЕЛЯ',
        subtitle: 'Минимальный набор вопросов',
        content: `<ul>
<li>Возраст.</li>
<li>Город или район проживания.</li>
<li>Состав семьи: один/семья/дети/многодетная семья.</li>
<li>Занятость: работает, самозанятый, предприниматель, студент, безработный, пенсионер.</li>
<li>Льготный статус: инвалидность, участник СВО или член семьи, малоимущая семья, молодая семья.</li>
<li>Цель обращения: деньги, жильё, лечение, обучение, бизнес, трудоустройство, документы.</li>
</ul>`
      },
      {
        title: 'КАРТОЧКА МЕРЫ ПОДДЕРЖКИ',
        subtitle: 'Что показывать по каждой мере',
        content: `<ul>
<li><strong>Название меры</strong> и ведомство.</li>
<li><strong>Кому положено:</strong> простыми словами.</li>
<li><strong>Размер поддержки:</strong> сумма, льгота, компенсация или услуга.</li>
<li><strong>Условия:</strong> ключевые ограничения и основания для отказа.</li>
<li><strong>Документы:</strong> что подготовить заранее.</li>
<li><strong>Сроки:</strong> подача, рассмотрение, получение результата.</li>
<li><strong>Как подать:</strong> Госуслуги, МФЦ, региональный портал, ведомство или другой канал.</li>
</ul>`
      },
      {
        title: 'ПОШАГОВЫЙ МАРШРУТ',
        subtitle: 'Что сервис должен подсказать после подбора',
        content: `<ol>
<li>Проверьте право на меру поддержки.</li>
<li>Подготовьте документы из списка.</li>
<li>Выберите канал подачи: Госуслуги, МФЦ, региональный портал или ведомство.</li>
<li>Подайте заявление.</li>
<li>Отслеживайте статус.</li>
<li>Если отказали — посмотрите причину и следующий возможный шаг.</li>
</ol>`
      }
    ]
  }
