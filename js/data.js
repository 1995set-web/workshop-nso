...
Ограничение: только реально работающие решения, не концепты. С примерами из других регионов.` },
    { label: 'Шаблон Г — Презентация в Gamma', text: `Создай структуру презентации на 8 слайдов для совещания Правительства НСО.
...
Стиль: деловой, кратко, без воды, с акцентом на цифры. Формат: текст для вставки в Gamma.` },
    { label: 'Шаблон Е — Навигатор господдержки для жителей НСО', text: `Создай HTML-прототип сервиса «Навигатор господдержки для жителей НСО».
...
- данные можно сделать демонстрационными, но реалистичными для НСО.` }
  ],
  hasTask: true,
...
<li>Инвестиционная привлекательность НСО.</li>
...
<li>Что нужно решить сегодня.</li>
  ...
  P3E: {
    ...
    title: 'Артефакт Е — ТЗ на сервис «Навигатор господдержки для жителей НСО»',
    sections: [
      {
        title: 'ИДЕЯ СЕРВИСА',
...
<li><strong>Данные:</strong> можно использовать демонстрационные меры, но они должны выглядеть реалистично для НСО.</li>
</ul>`
      },
      {
